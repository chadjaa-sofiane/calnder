...
const Modal = ({ children, open = false, setOpen = () => { } }: Props) => {
    ...
    return (
        <>
            {open && <div className="absolute inset-0 isolate">
                <div onClick={closeModal} className="cursor-pointer absolute inset-0 w-full h-full bg-slate-400 opacity-40 z-0"></div>
